...
public class ProfileBean extends ApplicationBean implements Serializable {
	...
	public ProfileBean() {
		...
		/*
		 * try { logMessages = user.getLogs(); } catch (SQLException e) { // TODO
	...
	public void saveProfile() throws SQLException {
		...
		getWebapplication().getUserManager().save(user);
	...
	public void validateUsername(FacesContext context, UIComponent component, Object value)
		...
		if (getWebapplication().getUserManager().isUsernameAlreadyTaken((String) value)) {
	...
	public void validatePassword(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		UIInput passwordInput = (UIInput) context.getViewRoot().findComponent("profile_passwordform:password");
